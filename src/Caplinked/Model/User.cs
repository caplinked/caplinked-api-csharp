...
namespace Caplinked.Model
{
    ...
    public partial class User :  IEquatable<User>, IValidatableObject
    {
        ...
        public User(int? Id = default(int?), string FirstName = default(string), string LastName = default(string), string Email = default(string), string TimeZone = default(string), string Jti = default(string))
        {
            this.Id = Id;
