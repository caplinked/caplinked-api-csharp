...
namespace Caplinked.Client
{
    ...
    public class Configuration
    {
        ...
        /// <summary>
        /// Set the Caplinked API public key.
        /// </summary>
        /// <param name="clApiPublicKey">Caplinked API public key.</param>
        /// <returns></returns>
        public void SetApiPublicKey (string clApiPublicKey = null)
        {
            if (clApiPublicKey != null)
            {
                AddApiKey("cl-api-public-key", clApiPublicKey);
            }
        }

        /// <summary>
        /// Set the Caplinked API secret key.
        /// </summary>
        /// <param name="clApiSecretKey">Caplinked API secret key.</param>
        /// <returns></returns>
        public void SetApiSecretKey (string clApiSecretKey = null)
        {
            if (clApiSecretKey != null)
            {
                AddApiKey("cl-api-secret-key", clApiSecretKey);
            }
        }

        /// <summary>
        /// Set the Caplinked API user resource token.
        /// </summary>
        /// <param name="clApiUserToken">Caplinked API user resource token.</param>
        /// <returns></returns>
        public void SetApiUserToken (string clApiUserToken = null)
        {
            if (clApiUserToken != null)
            {
                AddApiKey("cl-api-user-token", clApiUserToken);
            }
        }
        ...
        {
            String report = "C# SDK (Caplinked) Debug Report:\n";
            report += "    OS: " + Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + Assembly
                     .GetExecutingAssembly()
                     .GetReferencedAssemblies()
                     .Where(x => x.Name == "System.Core").First().Version.ToString()  + "\n";
            report += "    Version of the API: 2017-05-23\n";
